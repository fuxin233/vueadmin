    ...
    <div class="oneData" @mouseover="inside()" @mouseout="out()" v-for="item in tableData">
      ...
      >
        ...
        <div class="left" slot="reference" >
          <div class="inner" v-if="item.cpuType=='Intel'">
            <div class="innerleft"  :style="{width:item.cpuSingleIndex/138.3*100 + '%'}">{{item.cpuName}}</div>
          </div>
        </div>
      </el-popover>
      ...
      >
        ...
        <div class="right" slot="reference" v-if="item.cpuType=='Ryzen'" >
          <div class="innerR" >
            <div class="innerright"  :style="{width:item.cpuSingleIndex/138.3*100 + '%'}">{{item.cpuName}}</div>
          </div>
        </div>
      </el-popover>
    </div>
